globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, setCookie, appendHeader, parseCookies, getHeaders, getMethod, getQuery as getQuery$1, createError, isMethod, readBody, getResponseStatusText } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/h3/dist/index.mjs';
import SpotifyProvider from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/next-auth/providers/spotify.js';
import { AuthHandler } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/next-auth/core/index.js';
import { getToken as getToken$2 } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/next-auth/jwt/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/defu/dist/defu.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/klona/dist/index.mjs';
import { hash } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/radix3/dist/index.mjs';
import getURL from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/requrl/dist/requrl.js';
import { version, unref } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "SPOTIFY_CLIENT_ID": "75331327e9b847639941cadf5976dfd8",
  "SPOTIFY_CLIENT_SECRET": "5639707a39054c149daf7348cc0b6b06"
};
...
const serverAssets = [{"baseName":"server","dir":"/Users/alextana/code/nuxt/playlistr-new/Playlistr/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/alextana/code/nuxt/playlistr-new/Playlistr","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/alextana/code/nuxt/playlistr-new/Playlistr/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/alextana/code/nuxt/playlistr-new/Playlistr/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/alextana/code/nuxt/playlistr-new/Playlistr/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/alextana/code/nuxt/playlistr-new/Playlistr/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _DPLRL867Oe = defineNitroPlugin(() => {
  try {
    getServerOrigin();
  } catch (error) {
    {
...
const _tKr3cglPNJ = (function(nitro) {
...
const _lazy_IWTLBh = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_ZEzzdC = () => Promise.resolve().then(function () { return getGenres$1; });
const _lazy_gPAevn = () => Promise.resolve().then(function () { return getPlayerState$1; });
const _lazy_2uADNx = () => Promise.resolve().then(function () { return addToPlaylist$1; });
const _lazy_L4Y3T0 = () => Promise.resolve().then(function () { return generatePlaylist$1; });
const _lazy_OvInkH = () => Promise.resolve().then(function () { return getPlaylist$1; });
const _lazy_rhZcNj = () => Promise.resolve().then(function () { return getPlaylistItems$1; });
const _lazy_2b8zcQ = () => Promise.resolve().then(function () { return getPlaylists$1; });
const _lazy_feOwry = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/auth/**', handler: _lazy_IWTLBh, lazy: true, middleware: false, method: undefined },
  { route: '/api/genres/getGenres', handler: _lazy_ZEzzdC, lazy: true, middleware: false, method: undefined },
  { route: '/api/player/getPlayerState', handler: _lazy_gPAevn, lazy: true, middleware: false, method: undefined },
  { route: '/api/playlists/addToPlaylist', handler: _lazy_2uADNx, lazy: true, middleware: false, method: undefined },
  { route: '/api/playlists/generatePlaylist', handler: _lazy_L4Y3T0, lazy: true, middleware: false, method: undefined },
  { route: '/api/playlists/getPlaylist', handler: _lazy_OvInkH, lazy: true, middleware: false, method: undefined },
  { route: '/api/playlists/getPlaylistItems', handler: _lazy_rhZcNj, lazy: true, middleware: false, method: undefined },
  { route: '/api/playlists/getPlaylists', handler: _lazy_2b8zcQ, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_feOwry, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_feOwry, lazy: true, middleware: false, method: undefined }
];
...
const getToken$1 = ({ event, secureCookie, secret, ...rest }) => getToken$2({
...
const getPlaylists$2 = async (refresh_token) => {
...
const getPlaylist$2 = async (refresh_token, id2) => {
  const { access_token } = await getToken(refresh_token);
  return fetch(`${PLAYLIST_ENDPOINT}/${id2}`, {
    headers: {
      Authorization: `Bearer ${access_token}`
    },
    method: "GET"
...
const getPlaylistItems$2 = async (refresh_token, id2, offset) => {
  const { access_token } = await getToken(refresh_token);
  return fetch(`${PLAYLIST_ENDPOINT}/${id2}/tracks?limit=100&offset=${offset}`, {
    headers: {
      Authorization: `Bearer ${access_token}`
    },
    method: "GET"
...
const addToPlaylist$2 = async (refresh_token, playlistId, trackUri) => {
  const { access_token } = await getToken(refresh_token);
...
const createPlaylist = async (refresh_token, user_id, playlist_name) => {
  const { access_token } = await getToken(refresh_token);
  const playlist = {
    name: playlist_name
  };
...
const getRecommendations = async (refresh_token, tracks, seed_artists, seed_genres, seed_string, limit) => {
  const { access_token } = await getToken(refresh_token);
  if (!limit) {
    limit = "20";
  }
...
const getArtists = async (refresh_token, offset) => {
  const { access_token } = await getToken(refresh_token);
...
const getGenres$2 = async (refresh_token) => {
  const { access_token } = await getToken(refresh_token);
...
const getPlayerQueue = async (refresh_token) => {
  const { access_token } = await getToken(refresh_token);
...
const getGenres = defineEventHandler(async (event) => {
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
      statusCode: 401,
  ...
  const response = await getGenres$2(accessToken);
  const genres = await response.json();
  return genres;
});

const getGenres$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: getGenres
});

const getPlayerState = defineEventHandler(async (event) => {
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
      statusCode: 401,
...
const getPlayerState$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: getPlayerState
});

const addToPlaylist = defineEventHandler(async (event) => {
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
      statusCode: 401,
  ...
  const query = getQuery$1(event);
  const accessToken = token.accessToken;
  const response = await addToPlaylist$2(
    accessToken,
    query.playlistId,
    query.trackUri
  );
...
const addToPlaylist$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: addToPlaylist
});

const generatePlaylist = defineEventHandler(async (event) => {
  var _a;
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
  ...
  if (!query.seed_genres) {
    const offset = Math.floor(Math.random() * 20).toString();
    const artists = await getArtists(accessToken, offset);
    const artistsData = await artists.json();
    seed_artists = artistsData == null ? void 0 : artistsData.items.map(function(artist) {
      return artist["id"];
    });
  }
  const seed_string = seed_artists ? "seed_artists=" + seed_artists.join(",") : "seed_genres=" + query.seed_genres;
  ...
  const recommended = await (recommendedData == null ? void 0 : recommendedData.json());
  const tracks = (_a = recommended == null ? void 0 : recommended.tracks) == null ? void 0 : _a.map((track) => track.uri);
  if (tracks) {
    try {
      await addToPlaylist$2(accessToken, playlist.id, tracks.join(","));
    } catch (error) {
      throw createError({
        statusCode: 500,
...
const generatePlaylist$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: generatePlaylist
});

const getPlaylist = defineEventHandler(async (event) => {
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
      statusCode: 401,
  ...
  const query = getQuery$1(event);
  const accessToken = token.accessToken;
  const response = await getPlaylist$2(accessToken, query.id);
  const playlist = await response.json();
  return playlist;
});

const getPlaylist$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: getPlaylist
});

const getPlaylistItems = defineEventHandler(async (event) => {
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
      statusCode: 401,
  ...
  const query = getQuery$1(event);
  const accessToken = token.accessToken;
  const response = await getPlaylistItems$2(accessToken, query.id, query.offset);
  const playlist = await response.json();
  return playlist;
});

const getPlaylistItems$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: getPlaylistItems
});

const getPlaylists = defineEventHandler(async (event) => {
  const token = await getToken$1({ event });
  if (!token) {
    throw createError({
      statusCode: 401,
  ...
  const accessToken = token.accessToken;
  const response = await getPlaylists$2(accessToken);
  const items = await response.json();
  return items;
});

const getPlaylists$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"data-theme":"playlistr"}};
...
const getClientManifest = () => import('file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/alextana/code/nuxt/playlistr-new/Playlistr/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
